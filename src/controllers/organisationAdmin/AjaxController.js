...
exports.postAjaxCeo = async(req,res,next) =>{
    ...
    let org = await OrganisationService.findOneOrgByEmail(ceoEmail).withBasicInfoOrg().execute();
    if(!org){
...
exports.postAjaxOrgName = async(req,res,next) =>{
    ...
    let companyName = await OrganisationService.findOneByOrgName(orgName).withBasicInfoOrg().execute();
...
exports.postAjaxOrgId = async(req,res,next) =>{
    ...
    let companyNameArr = await OrganisationService.findOrgByEmail(ceoEmail).withBasicInfoOrg().execute();
...
exports.postAjaxManagerEmail = async(req,res,next)=>{
    ...
    let emp = await EmployeeService.findEmpByWorkEmail(managerEmail).withNameInfoEmp().execute();
    if(!emp){
